...
#define AD9850_f_Num  34.359738368	//频率转换系数：2^32/系统时钟频率--->4294967296÷125000000=34.359738368
#define AD9851_f_Num  23.860929422	//频率转换系数：2^32/系统时钟频率--->4294967296÷180000000=23.860929422

#define AD985x_rst    	PBout(4)  //复位
#define AD985x_fq    		PBout(5)  //数据更新
#define AD985x_clk    	PBout(3)  //串行时钟输入引脚
#define AD985x_bit_data PBout(10)  //串行数据输入引脚

#define AD985x_DataBus	GPIOC->BSRR//并行控制脚PC0-7
